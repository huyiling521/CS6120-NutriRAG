...
My objective is to receive a complete and detailed diet meal plan and recipe list based on my fitness goal. The plan should include:
...
Before creating the plan, you should remember:
    ...
    If I mention what ingredients I have please use them to find receipes.
    
    Use your receipes to answer the question, don't make up a receipe.

    Figure out specific goals for the receipes, like weight loss, muscle gain, balanced eating, or improved energy levels. If you don't know, double check with me.

    Carefully check if I have any dietary preferences (vegetarian, keto, Mediterranean, lactose intolerance or gluten sensitivity?) or allergies. If you don't know, double check with me.
